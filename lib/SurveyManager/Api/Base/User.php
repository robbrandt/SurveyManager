 ...
 */
class SurveyManager_Api_Base_User extends Zikula_AbstractApi
{
    /**
    ...
    public function getlinks()
    {
        ...
        if (in_array('survey', $allowedObjectTypes)
            && SecurityUtil::checkPermission($this->name . ':Survey:', '::', ACCESS_READ)) {
            $links[] = array('url' => ModUtil::url($this->name, 'user', 'view', array('ot' => 'survey')),
                             'text' => $this->__('Surveys'),
                             'title' => $this->__('Survey list'));
        }
        if (in_array('page', $allowedObjectTypes)
            && SecurityUtil::checkPermission($this->name . ':Page:', '::', ACCESS_READ)) {
            $links[] = array('url' => ModUtil::url($this->name, 'user', 'view', array('ot' => 'page')),
                             'text' => $this->__('Pages'),
                             'title' => $this->__('Page list'));
        }
        if (in_array('question', $allowedObjectTypes)
            && SecurityUtil::checkPermission($this->name . ':Question:', '::', ACCESS_READ)) {
            $links[] = array('url' => ModUtil::url($this->name, 'user', 'view', array('ot' => 'question')),
                             'text' => $this->__('Questions'),
                             'title' => $this->__('Question list'));
        }
        if (in_array('response', $allowedObjectTypes)
            && SecurityUtil::checkPermission($this->name . ':Response:', '::', ACCESS_READ)) {
            $links[] = array('url' => ModUtil::url($this->name, 'user', 'view', array('ot' => 'response')),
                             'text' => $this->__('Responses'),
                             'title' => $this->__('Response list'));
        }
        if (in_array('responseData', $allowedObjectTypes)
            && SecurityUtil::checkPermission($this->name . ':ResponseData:', '::', ACCESS_READ)) {
            $links[] = array('url' => ModUtil::url($this->name, 'user', 'view', array('ot' => 'responseData')),
    ...
    public function encodeurl(array $args = array())
    {
        ...
        $routerFacade = new SurveyManager_RouterFacade();
        ...
        $modInfo = ModUtil::getInfoFromName('SurveyManager');
    ...
    public function decodeurl(array $args = array())
    {
        ...
        $funcs = array('main', 'view', 'display', 'processPage', 'clearResponses', 'thankYou', 'viewFeatured', 'displayFeatured', 'detailFeatured', 'viewResponse');
