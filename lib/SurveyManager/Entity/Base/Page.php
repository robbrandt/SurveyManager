 ...
 * @abstract
 */
abstract class SurveyManager_Entity_Base_Page extends Zikula_EntityAccess
{
    /**
    ...
    /**
     * @var SurveyManager_Entity_Validator_Page The validator for this entity.
     */
    ...
    /**
     * Bidirectional - Many pages [pages] are linked by one survey [survey] (OWNING SIDE).
     *
     * @ORM\ManyToOne(targetEntity="SurveyManager_Entity_Survey", inversedBy="pages")
    ...
    /**
     * Bidirectional - One page [page] has many questions [questions] (INVERSE SIDE).
     *
     * @ORM\OneToMany(targetEntity="SurveyManager_Entity_Question", mappedBy="page", cascade={"remove"})
     * @ORM\JoinTable(name="surveyman_pagequestions")
     * @ORM\OrderBy({"weight" = "ASC"})
     * @var SurveyManager_Entity_Question[] $questions.
     */
     ...
     * Get _validator.
     *
     * @return SurveyManager_Entity_Validator_Page
     */
     ...
     * Set _validator.
     *
     * @param SurveyManager_Entity_Validator_Page $_validator.
     *
     * @return void
     */
    public function set_validator(SurveyManager_Entity_Validator_Page $_validator = null)
    {
     ...
     * Set questions.
     *
     * @param SurveyManager_Entity_Question[] $questions.
     *
     * @return void
     */
    ...
    /**
     * Adds an instance of SurveyManager_Entity_Question to the list of questions.
     *
     * @param SurveyManager_Entity_Question $question The instance to be added to the collection.
     *
     * @return void
     */
    public function addQuestions(SurveyManager_Entity_Question $question)
    {
    ...
    /**
     * Removes an instance of SurveyManager_Entity_Question from the list of questions.
     *
     * @param SurveyManager_Entity_Question $question The instance to be removed from the collection.
     *
     * @return void
     */
    public function removeQuestions(SurveyManager_Entity_Question $question)
    {
     ...
     *
     * @return SurveyManager_Entity_Validator_Page The validator for this entity.
     */
    public function initValidator()
    {
        ...
        $this->_validator = new SurveyManager_Entity_Validator_Page($this);
    ...
    protected function prepareItemActions()
    {
        ...
        if ($currentType == 'admin') {
            if (in_array($currentFunc, array('main', 'view'))) {
                $this->_actions[] = array(
                    'url' => array('type' => 'user', 'func' => 'display', 'arguments' => array('ot' => 'page', 'id' => $this['id'])),
                    'icon' => 'preview',
            ...
            if (in_array($currentFunc, array('main', 'view', 'display'))) {
                $component = 'SurveyManager:Page:';
                $instance = $this->id . '::';
                if (SecurityUtil::checkPermission($component, $instance, ACCESS_EDIT)) {
                    $this->_actions[] = array(
                        'url' => array('type' => 'admin', 'func' => 'edit', 'arguments' => array('ot' => 'page', 'id' => $this['id'])),
                        'icon' => 'edit',
                        'linkTitle' => __('Edit', $dom),
                        'linkText' => __('Edit', $dom)
                    );
                    $this->_actions[] = array(
                        'url' => array('type' => 'admin', 'func' => 'edit', 'arguments' => array('ot' => 'page', 'astemplate' => $this['id'])),
                        'icon' => 'saveas',
            ...
            if ($authAdmin || (isset($uid) && isset($this->createdUserId) && $this->createdUserId == $uid)) {
                ...
                $urlArgs = array('ot' => 'question',
                                 'page' => $this->id);
                if ($currentFunc == 'view') {
                    $urlArgs['returnTo'] = 'adminViewPage';
                } elseif ($currentFunc == 'display') {
                    $urlArgs['returnTo'] = 'adminDisplayPage';
                }
                $this->_actions[] = array(
                    'url' => array('type' => 'admin', 'func' => 'edit', 'arguments' => $urlArgs),
                    'icon' => 'add',
                    'linkTitle' => __('Create question', $dom),
                    'linkText' => __('Create question', $dom)
                );
            }
        }
        if ($currentType == 'user') {
            ...
            if ($currentFunc == 'display') {
                $this->_actions[] = array(
                    'url' => array('type' => 'user', 'func' => 'view', 'arguments' => array('ot' => 'page')),
                    'icon' => 'back',
    ...
    {
        return 'surveymanager.ui_hooks.pages';
    }
     ...
     *
     * @see SurveyManager_Entity_Page::postLoadCallback()
     ...
     *
     * @see SurveyManager_Entity_Page::prePersistCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - no access to entity manager or unit of work apis
     *
     * @see SurveyManager_Entity_Page::postPersistCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *
     * @see SurveyManager_Entity_Page::preRemoveCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - will not be called for a DQL DELETE statement
     *
     * @see SurveyManager_Entity_Page::postRemoveCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - no creation of other entities allowed
     *
     * @see SurveyManager_Entity_Page::preUpdateCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - will not be called for a DQL UPDATE statement
     *
     * @see SurveyManager_Entity_Page::postUpdateCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *
     * @see SurveyManager_Entity_Page::preSaveCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     * For more information see corresponding callback handlers.
     *
     * @see SurveyManager_Entity_Page::postSaveCallback()
     * @return boolean true if completed successfully else false.
     */
