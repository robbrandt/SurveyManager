 ...
 *
 * This is the base entity class for response data entities.
 *
 * @abstract
 */
abstract class SurveyManager_Entity_Base_ResponseData extends Zikula_EntityAccess
{
    /**
     * @var string The tablename this object maps to.
     */
    protected $_objectType = 'responseData';
    
    /**
     * @var SurveyManager_Entity_Validator_ResponseData The validator for this entity.
     */
    ...
    /**
     * @ORM\Column(type="smallint")
     * @var integer $correctness.
     */
    protected $correctness = 0;
    ...
    /**
     * Bidirectional - Many answers [response datas] are linked by one response [response] (OWNING SIDE).
     *
     * @ORM\ManyToOne(targetEntity="SurveyManager_Entity_Response", inversedBy="answers")
     * @ORM\JoinColumn(name="response_id", referencedColumnName="id" )
     * @var SurveyManager_Entity_Response $response.
     */
    protected $response;
    
    /**
     * Bidirectional - Many answers [response datas] are linked by one question [question] (OWNING SIDE).
     *
     * @ORM\ManyToOne(targetEntity="SurveyManager_Entity_Question", inversedBy="answers")
     * @ORM\JoinColumn(name="question_id", referencedColumnName="id" )
     * @var SurveyManager_Entity_Question $question.
     */
    protected $question;
     ...
     * Get _validator.
     *
     * @return SurveyManager_Entity_Validator_ResponseData
     */
     ...
     * Set _validator.
     *
     * @param SurveyManager_Entity_Validator_ResponseData $_validator.
     *
     * @return void
     */
    public function set_validator(SurveyManager_Entity_Validator_ResponseData $_validator = null)
    {
     ...
     * Set response value.
     *
     * @param text $responseValue.
     *
     * @return void
     */
    public function setResponseValue($responseValue)
    {
        if ($responseValue != $this->responseValue) {
     ...
     * Set correctness.
     *
     * @param smallint $correctness.
     *
     * @return void
     */
    public function setCorrectness($correctness)
    {
        if ($correctness != $this->correctness) {
     ...
     * Set response.
     *
     * @param SurveyManager_Entity_Response $response.
     *
     * @return void
     */
    public function setResponse(SurveyManager_Entity_Response $response = null)
    {
     ...
     * Get question.
     *
     * @return SurveyManager_Entity_Question
     */
     ...
     * Set question.
     *
     * @param SurveyManager_Entity_Question $question.
     *
     * @return void
     */
    public function setQuestion(SurveyManager_Entity_Question $question = null)
    {
     ...
     *
     * @return SurveyManager_Entity_Validator_ResponseData The validator for this entity.
     */
    public function initValidator()
    {
        ...
        $this->_validator = new SurveyManager_Entity_Validator_ResponseData($this);
    ...
    protected function prepareItemActions()
    {
        ...
        if ($currentType == 'admin') {
            if (in_array($currentFunc, array('main', 'view'))) {
                $this->_actions[] = array(
                    'url' => array('type' => 'user', 'func' => 'display', 'arguments' => array('ot' => 'responseData', 'id' => $this['id'])),
                    'icon' => 'preview',
            ...
            if (in_array($currentFunc, array('main', 'view', 'display'))) {
                $component = 'SurveyManager:ResponseData:';
                $instance = $this->id . '::';
                if (SecurityUtil::checkPermission($component, $instance, ACCESS_EDIT)) {
                    $this->_actions[] = array(
                        'url' => array('type' => 'admin', 'func' => 'edit', 'arguments' => array('ot' => 'responseData', 'id' => $this['id'])),
                        'icon' => 'edit',
                        'linkTitle' => __('Edit', $dom),
                        'linkText' => __('Edit', $dom)
                    );
                    $this->_actions[] = array(
                        'url' => array('type' => 'admin', 'func' => 'edit', 'arguments' => array('ot' => 'responseData', 'astemplate' => $this['id'])),
                        'icon' => 'saveas',
        ...
        if ($currentType == 'user') {
            ...
            if ($currentFunc == 'display') {
                $this->_actions[] = array(
                    'url' => array('type' => 'user', 'func' => 'view', 'arguments' => array('ot' => 'responseData')),
                    'icon' => 'back',
    ...
    {
        return 'surveymanager.ui_hooks.responsedatas';
    }
     ...
     *
     * @see SurveyManager_Entity_ResponseData::postLoadCallback()
    ...
    protected function performPostLoadCallback()
    {
        ...
        if ($currentFunc != 'edit' && $currentFunc != 'exportSurvey') { /** ADDED */
            $this['responseValue'] = ((isset($this['responseValue']) && !empty($this['responseValue'])) ? DataUtil::formatForDisplayHTML($this['responseValue']) : ''); /** ADDED */
            //$this->formatTextualField('responseValue', $currentFunc, $usesCsvOutput); /** Original code */
        } /** ADDED */
        
        $this['grade'] = (int) ((isset($this['grade']) && !empty($this['grade'])) ? DataUtil::formatForDisplay($this['grade']) : 0);
        $this['correctness'] = (int) ((isset($this['correctness']) && !empty($this['correctness'])) ? DataUtil::formatForDisplay($this['correctness']) : 0);
     ...
     *
     * @see SurveyManager_Entity_ResponseData::prePersistCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - no access to entity manager or unit of work apis
     *
     * @see SurveyManager_Entity_ResponseData::postPersistCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *
     * @see SurveyManager_Entity_ResponseData::preRemoveCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - will not be called for a DQL DELETE statement
     *
     * @see SurveyManager_Entity_ResponseData::postRemoveCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - no creation of other entities allowed
     *
     * @see SurveyManager_Entity_ResponseData::preUpdateCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - will not be called for a DQL UPDATE statement
     *
     * @see SurveyManager_Entity_ResponseData::postUpdateCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *
     * @see SurveyManager_Entity_ResponseData::preSaveCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     * For more information see corresponding callback handlers.
     *
     * @see SurveyManager_Entity_ResponseData::postSaveCallback()
     * @return boolean true if completed successfully else false.
     */
    ...
    {
        $formattedTitle = $this->getResponseValue();
