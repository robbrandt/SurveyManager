 ...
 *
 * This is the base entity class for response entities.
 *
 * @abstract
 */
abstract class SurveyManager_Entity_Base_Response extends Zikula_EntityAccess
{
    /**
     * @var string The tablename this object maps to.
     */
    protected $_objectType = 'response';
    
    /**
     * @var SurveyManager_Entity_Validator_Response The validator for this entity.
     */
    ...
    /**
     * Bidirectional - Many responses [responses] are linked by one survey [survey] (OWNING SIDE).
     *
     * @ORM\ManyToOne(targetEntity="SurveyManager_Entity_Survey", inversedBy="responses")
     * @ORM\JoinColumn(name="survey_id", referencedColumnName="id" )
     * @var SurveyManager_Entity_Survey $survey.
     */
    protected $survey;
    
    /**
     * Bidirectional - One response [response] has many answers [response datas] (INVERSE SIDE).
     *
     * @ORM\OneToMany(targetEntity="SurveyManager_Entity_ResponseData", mappedBy="response", cascade={"remove"})
     * @ORM\JoinTable(name="surveyman_responseanswers")
     ...
     * Get _validator.
     *
     * @return SurveyManager_Entity_Validator_Response
     */
     ...
     * Set _validator.
     *
     * @param SurveyManager_Entity_Validator_Response $_validator.
     *
     * @return void
     */
    public function set_validator(SurveyManager_Entity_Validator_Response $_validator = null)
    {
     ...
     *
     * @param bigint $responseTimestamp.
     *
     * @return void
     */
    public function setResponseTimestamp($responseTimestamp)
    {
        if ($responseTimestamp != $this->responseTimestamp) {
     ...
     * Get survey.
     *
     * @return SurveyManager_Entity_Survey
     */
     ...
     * Set survey.
     *
     * @param SurveyManager_Entity_Survey $survey.
     *
     * @return void
     */
    public function setSurvey(SurveyManager_Entity_Survey $survey = null)
    {
        $this->survey = $survey;
    }
     ...
     *
     * @return SurveyManager_Entity_Validator_Response The validator for this entity.
     */
    public function initValidator()
    {
        ...
        $this->_validator = new SurveyManager_Entity_Validator_Response($this);
    ...
    protected function prepareItemActions()
    {
        ...
        if ($currentType == 'admin') {
            if (in_array($currentFunc, array('main', 'view'))) {
                $this->_actions[] = array(
                    'url' => array('type' => 'user', 'func' => 'display', 'arguments' => array('ot' => 'response', 'id' => $this['id'])),
                    'icon' => 'preview',
            ...
            if (in_array($currentFunc, array('main', 'view', 'display'))) {
                $component = 'SurveyManager:Response:';
                $instance = $this->id . '::';
                if (SecurityUtil::checkPermission($component, $instance, ACCESS_EDIT)) {
                    $this->_actions[] = array(
                        'url' => array('type' => 'admin', 'func' => 'edit', 'arguments' => array('ot' => 'response', 'id' => $this['id'])),
                        'icon' => 'edit',
                        'linkTitle' => __('Edit', $dom),
                        'linkText' => __('Edit', $dom)
                    );
                    $this->_actions[] = array(
                        'url' => array('type' => 'admin', 'func' => 'edit', 'arguments' => array('ot' => 'response', 'astemplate' => $this['id'])),
                        'icon' => 'saveas',
            ...
            if ($authAdmin || (isset($uid) && isset($this->createdUserId) && $this->createdUserId == $uid)) {
                ...
                $urlArgs = array('ot' => 'responseData',
                                 'response' => $this->id);
                if ($currentFunc == 'view') {
                    $urlArgs['returnTo'] = 'adminViewResponse';
                } elseif ($currentFunc == 'display') {
                    $urlArgs['returnTo'] = 'adminDisplayResponse';
                }
                $this->_actions[] = array(
        ...
        if ($currentType == 'user') {
            ...
            if ($currentFunc == 'display') {
                $this->_actions[] = array(
                    'url' => array('type' => 'user', 'func' => 'view', 'arguments' => array('ot' => 'response')),
                    'icon' => 'back',
    ...
    {
        return 'surveymanager.ui_hooks.responses';
    }
     ...
     *
     * @see SurveyManager_Entity_Response::postLoadCallback()
    ...
    protected function performPostLoadCallback()
    {
        ...
        $this->formatTextualField('ipAddress', $currentFunc, $usesCsvOutput);
        $this['responseTimestamp'] = (int) ((isset($this['responseTimestamp']) && !empty($this['responseTimestamp'])) ? DataUtil::formatForDisplay($this['responseTimestamp']) : 0);
        $this['featured'] = (bool) $this['featured'];
     ...
     *
     * @see SurveyManager_Entity_Response::prePersistCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - no access to entity manager or unit of work apis
     *
     * @see SurveyManager_Entity_Response::postPersistCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *
     * @see SurveyManager_Entity_Response::preRemoveCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - will not be called for a DQL DELETE statement
     *
     * @see SurveyManager_Entity_Response::postRemoveCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - no creation of other entities allowed
     *
     * @see SurveyManager_Entity_Response::preUpdateCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - will not be called for a DQL UPDATE statement
     *
     * @see SurveyManager_Entity_Response::postUpdateCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *
     * @see SurveyManager_Entity_Response::preSaveCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     * For more information see corresponding callback handlers.
     *
     * @see SurveyManager_Entity_Response::postSaveCallback()
     * @return boolean true if completed successfully else false.
     */
    ...
    {
        $formattedTitle = $this->getIpAddress();
