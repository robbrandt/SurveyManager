 ...
 * @abstract
 */
abstract class SurveyManager_Entity_Base_Question extends Zikula_EntityAccess
{
    /**
    ...
    /**
     * @var SurveyManager_Entity_Validator_Question The validator for this entity.
     */
     ...
     * @var array $questionValues.
     */
    protected $questionValues = array();
    
    /**
     * @ORM\Column(type="array")
     * @var array $correctValues.
     */
    protected $correctValues = array();
    ...
    /**
     * Bidirectional - Many questions [questions] are linked by one page [page] (OWNING SIDE).
     *
     * @ORM\ManyToOne(targetEntity="SurveyManager_Entity_Page", inversedBy="questions")
     * @ORM\JoinColumn(name="page_id", referencedColumnName="id" )
     * @var SurveyManager_Entity_Page $page.
     */
    protected $page;
    
    /**
     * Bidirectional - One question [question] has many answers [response datas] (INVERSE SIDE).
     *
     * @ORM\OneToMany(targetEntity="SurveyManager_Entity_ResponseData", mappedBy="question", cascade={"remove"})
     * @ORM\JoinTable(name="surveyman_questionanswers")
     * @var SurveyManager_Entity_ResponseData[] $answers.
     */
     ...
     * Get _validator.
     *
     * @return SurveyManager_Entity_Validator_Question
     */
     ...
     * Set _validator.
     *
     * @param SurveyManager_Entity_Validator_Question $_validator.
     *
     * @return void
     */
    public function set_validator(SurveyManager_Entity_Validator_Question $_validator = null)
    {
    ...
    {
        if ($questionType != $this->questionType) {
     ...
     * @return void
     */
    public function setQuestionValues($questionValues)
    {
        if ($questionValues != $this->questionValues) {
     ...
     * @return void
     */
    public function setCorrectValues($correctValues)
    {
        if ($correctValues != $this->correctValues) {
     ...
     * Set page.
     *
     * @param SurveyManager_Entity_Page $page.
     *
     * @return void
     */
    public function setPage(SurveyManager_Entity_Page $page = null)
    {
        $this->page = $page;
    }
     ...
     * Get answers.
     *
     * @return SurveyManager_Entity_ResponseData[]
     */
     ...
     * Set answers.
     *
     * @param SurveyManager_Entity_ResponseData[] $answers.
     *
     * @return void
     */
    public function setAnswers($answers)
    {
        foreach ($answers as $responseDataSingle) {
            $this->addAnswers($responseDataSingle);
        }
    }
    
    /**
     * Adds an instance of SurveyManager_Entity_ResponseData to the list of answers.
     *
     * @param SurveyManager_Entity_ResponseData $responseData The instance to be added to the collection.
     *
     * @return void
     */
    public function addAnswers(SurveyManager_Entity_ResponseData $responseData)
    {
        $this->answers->add($responseData);
        $responseData->setQuestion($this);
    }
    
    /**
     * Removes an instance of SurveyManager_Entity_ResponseData from the list of answers.
     *
     * @param SurveyManager_Entity_ResponseData $responseData The instance to be removed from the collection.
     *
     * @return void
     */
    public function removeAnswers(SurveyManager_Entity_ResponseData $responseData)
    {
        $this->answers->removeElement($responseData);
        $responseData->setQuestion(null);
    }
     ...
     *
     * @return SurveyManager_Entity_Validator_Question The validator for this entity.
     */
    public function initValidator()
    {
        ...
        $this->_validator = new SurveyManager_Entity_Validator_Question($this);
    ...
    protected function prepareItemActions()
    {
        ...
        if ($currentType == 'admin') {
            if (in_array($currentFunc, array('main', 'view'))) {
                $this->_actions[] = array(
                    'url' => array('type' => 'user', 'func' => 'display', 'arguments' => array('ot' => 'question', 'id' => $this['id'])),
                    'icon' => 'preview',
            ...
            if (in_array($currentFunc, array('main', 'view', 'display'))) {
                $component = 'SurveyManager:Question:';
                $instance = $this->id . '::';
                if (SecurityUtil::checkPermission($component, $instance, ACCESS_EDIT)) {
                    $this->_actions[] = array(
                        'url' => array('type' => 'admin', 'func' => 'edit', 'arguments' => array('ot' => 'question', 'id' => $this['id'])),
                        'icon' => 'edit',
                        'linkTitle' => __('Edit', $dom),
                        'linkText' => __('Edit', $dom)
                    );
                    $this->_actions[] = array(
                        'url' => array('type' => 'admin', 'func' => 'edit', 'arguments' => array('ot' => 'question', 'astemplate' => $this['id'])),
                        'icon' => 'saveas',
            ...
            if ($authAdmin || (isset($uid) && isset($this->createdUserId) && $this->createdUserId == $uid)) {
                ...
                $urlArgs = array('ot' => 'responseData',
                                 'question' => $this->id);
                if ($currentFunc == 'view') {
                    $urlArgs['returnTo'] = 'adminViewQuestion';
                } elseif ($currentFunc == 'display') {
                    $urlArgs['returnTo'] = 'adminDisplayQuestion';
                }
                $this->_actions[] = array(
                    'url' => array('type' => 'admin', 'func' => 'edit', 'arguments' => $urlArgs),
                    'icon' => 'add',
                    'linkTitle' => __('Create response data', $dom),
                    'linkText' => __('Create response data', $dom)
                );
            }
        }
        if ($currentType == 'user') {
            ...
            if ($currentFunc == 'display') {
                $this->_actions[] = array(
                    'url' => array('type' => 'user', 'func' => 'view', 'arguments' => array('ot' => 'question')),
                    'icon' => 'back',
    ...
    {
        return 'surveymanager.ui_hooks.questions';
    }
     ...
     *
     * @see SurveyManager_Entity_Question::postLoadCallback()
    ...
    protected function performPostLoadCallback()
    {
        ...
        $this->formatTextualField('questionType', $currentFunc, $usesCsvOutput);
        $this['questionValues'] = ((isset($this['questionValues']) && is_array($this['questionValues'])) ? DataUtil::formatForDisplay($this['questionValues']) : array());
        $this['correctValues'] = ((isset($this['correctValues']) && is_array($this['correctValues'])) ? DataUtil::formatForDisplay($this['correctValues']) : array());
        $this['required'] = (bool) $this['required'];
        $this['dependencies'] = ((isset($this['dependencies']) && is_array($this['dependencies'])) ? DataUtil::formatForDisplay($this['dependencies']) : array());
     ...
     *
     * @see SurveyManager_Entity_Question::prePersistCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - no access to entity manager or unit of work apis
     *
     * @see SurveyManager_Entity_Question::postPersistCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *
     * @see SurveyManager_Entity_Question::preRemoveCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - will not be called for a DQL DELETE statement
     *
     * @see SurveyManager_Entity_Question::postRemoveCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - no creation of other entities allowed
     *
     * @see SurveyManager_Entity_Question::preUpdateCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - will not be called for a DQL UPDATE statement
     *
     * @see SurveyManager_Entity_Question::postUpdateCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *
     * @see SurveyManager_Entity_Question::preSaveCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     * For more information see corresponding callback handlers.
     *
     * @see SurveyManager_Entity_Question::postSaveCallback()
     * @return boolean true if completed successfully else false.
     */
