 ...
 */
class SurveyManager_Entity_Repository_Base_Page extends EntityRepository
{
    /**
    ...
    public function getAdditionalTemplateParameters($context = '', $args = array())
    {
        ...
        if ($context == 'controllerAction') {
            ...
            if (in_array($args['action'], array('main', 'view'))) {
                ...
                $templateParameters['workflowStateItems'] = $listHelper->getEntries('page', 'workflowState');
            }
    ...
    public function truncateTable()
    {
        ...
        $qb->delete('SurveyManager_Entity_Page', 'tbl');
        $query = $qb->getQuery();
    ...
    public function updateCreator($userId, $newUserId)
    {
        ...
        $qb = $this->getEntityManager()->createQueryBuilder();
        $qb->update('SurveyManager_Entity_Page', 'tbl')
     ...
     *
     * @return array|SurveyManager_Entity_Page retrieved data array or SurveyManager_Entity_Page instance
     *
     * @throws InvalidArgumentException Thrown if invalid parameters are received
     */
     ...
     * @param boolean $slimMode If activated only some basic fields are selected without using any joins (optional) (default=false).
     *
     * @return ArrayCollection collection containing retrieved SurveyManager_Entity_Page instances
     *
     * @throws InvalidArgumentException Thrown if invalid parameters are received
     */
    ...
    public function addCommonViewFilters(QueryBuilder $qb)
    {
        ...
        foreach ($parameters as $k => $v) {
            if ($k == 'catId') {
                 ...
                 */
                $qb = ModUtil::apiFunc('SurveyManager', 'category', 'buildFilterClauses', array('qb' => $qb, 'ot' => 'page', 'catids' => $v));
            } elseif ($k == 'searchterm') {
                // quick search
                if (!empty($v)) {
    ...
    protected function getCountQuery($where = '', $useJoins = true)
    {
        ...
        $qb = $this->getEntityManager()->createQueryBuilder();
        $qb->select($selection)
           ->from('SurveyManager_Entity_Page', 'tbl');
     ...
     * @param int    $excludeId  Id of pages to exclude (optional).
     *
    ...
    {
        $selection = ', tblSurvey, tblQuestions';
