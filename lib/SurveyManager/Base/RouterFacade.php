 ...
 */
class SurveyManager_Base_RouterFacade
{
    /**
    ...
    protected function initUrlRoutes()
    {
        ...
        $isDefaultModule = (System::getVar('shorturlsdefaultmodule', '') == 'SurveyManager');
    
        $defaults = array();
        $modulePrefix = '';
        if (!$isDefaultModule) {
            $defaults['module'] = 'SurveyManager';
            $modulePrefix = ':module/';
        }
        ...
        if ($func == 'view') {
            switch ($objectType) {
                ...
                case 'page':
                            ...
                            break;
                case 'question':
                            $groupFolder = 'questions';
                            break;
                case 'response':
                            $groupFolder = 'responses';
                            break;
                case 'responseData':
                            $groupFolder = 'responsedatas';
                            break;
                default: return '';
            }
            ...
            switch ($objectType) {
                ...
                case 'page':
                            ...
                            break;
                case 'question':
                            $groupFolder = 'question';
                            break;
                case 'response':
                            $groupFolder = 'response';
                            break;
                case 'responseData':
                            $groupFolder = 'responsedata';
                            break;
                default: return '';
            }
        }
    ...
    public function getFormattedSlug($objectType, $func, $args, $itemid)
    {
        ...
        switch ($objectType) {
            case 'survey':
                $item = ModUtil::apiFunc('SurveyManager', 'selection', 'getEntity', array('ot' => $objectType, 'id' => $itemid, 'slimMode' => true));
                $slug = $item['slug'];
                        break;
            case 'page':
                $slug = $itemid;
