 ...
 */
class SurveyManager_ContentType_Base_ItemList extends Content_AbstractContentType
{
    /**
    ...
    public function getTitle()
    {
        ...
        return __('SurveyManager list view', $dom);
    }
    ...
    public function getDescription()
    {
        ...
        return __('Display list of SurveyManager objects.', $dom);
    }
    ...
    public function loadData(&$data)
    {
        ...
        $controllerHelper = new SurveyManager_Util_Controller($serviceManager);
    ...
    public function display()
    {
        ...
        $entityClass = 'SurveyManager_Entity_' . ucwords($this->objectType);
        $serviceManager = ServiceUtil::getManager();
        $entityManager = $serviceManager->getService('doctrine.entitymanager');
        $repository = $entityManager->getRepository($entityClass);
    
        // ensure that the view does not look for templates in the Content module (#218)
        $this->view->toplevelmodule = 'SurveyManager';
    
        $this->view->setCaching(Zikula_View::CACHE_ENABLED);
        // set cache id
        $component = 'SurveyManager:' . ucwords($this->objectType) . ':';
        $instance = '::';
    ...
    protected function getSortParam($repository)
    {
        ...
        if ($this->sorting == 'newest') {
            $idFields = ModUtil::apiFunc('SurveyManager', 'selection', 'getIdFields', array('ot' => $this->objectType));
            if (count($idFields) == 1) {
    ...
    {
        return array('objectType' => 'survey',
                     'sorting' => 'default',
                     'amount' => 1,
    ...
    public function startEditing()
    {
        ...
        array_push($this->view->plugins_dir, 'modules/SurveyManager/templates/plugins');
    }
}
