 ...
 */
class SurveyManager_Listener_ModuleDispatch extends SurveyManager_Listener_Base_ModuleDispatch
{
    /**
    ...
    public static function serviceLinks(Zikula_Event $event)
    {
        ...
        // Format data like so:
        // $event->data[] = array('url' => ModUtil::url('SurveyManager', 'user', 'main'), 'text' => __('Link Text'));
    }
}
