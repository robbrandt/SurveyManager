...
/**
 * Question type class for topic names.
 */
class SurveyManager_QuestionType_TopicName extends SurveyManager_AbstractQuestionType
{
    /**
    ...
    public function getEditInput($question, $response, $context = '')
    {
        ...
        return $this->getHiddenInput($question, $this->getTopicName());
    }

    /**
     * Selects the name for a certain topic.
     */
    protected function getTopicName($uname)
    {
