...
/**
 * Question type class for integer values.
 */
class SurveyManager_QuestionType_Int extends SurveyManager_AbstractQuestionType
{
    /**
    ...
    public function getEditInput($question, $response, $context = '')
    {
        ...
        $output = '<input class="' . $cssClass . 'validate-digits" type="text" id="responses_' . $questionId . '" name="responses[' . $questionId . ']" size="4" value="' . DataUtil::formatForDisplay($response) . "\" />\n";
        ...
        $output .= '<p id="advice-validate-digits-responses_' . $questionId . '" class="custom-advice" style="display: none">' . $this->__('Please only enter numeric digits in this field.') . "</p>\n";
