...
/**
 * Question type class for user real names.
 */
class SurveyManager_QuestionType_UserRealName extends SurveyManager_AbstractQuestionType
{
    /**
    ...
    public function getEditInput($question, $response, $context = '')
    {
        ...
        $name = UserUtil::getVar('name');
        if (!$name) {
            // fallback to username
            $name = UserUtil::getVar('uname');
        }
        return $this->getHiddenInput($question, $name);
    }
