...
/**
 * Question type class for user ids.
 */
class SurveyManager_QuestionType_UserId extends SurveyManager_AbstractQuestionType
{
    /**
    ...
    public function getEditInput($question, $response, $context = '')
    {
        ...
        return $this->getHiddenInput($question, UserUtil::getVar('uid'));
    }
}
