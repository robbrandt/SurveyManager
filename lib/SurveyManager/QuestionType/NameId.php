...
/**
 * Question type class for name identifiers.
 */
class SurveyManager_QuestionType_NameId extends SurveyManager_AbstractQuestionType
{
    /**
    ...
    {
        return $this->__('Name identifier');
    }
