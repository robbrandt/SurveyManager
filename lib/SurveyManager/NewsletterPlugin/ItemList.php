 ...
 */
class SurveyManager_NewsletterPlugin_ItemList extends Newsletter_AbstractPlugin
{
    /**
    ...
    {
        return $this->__('Latest SurveyManager items');
    }
    ...
    {
        return $this->__('List of surveys and other SurveyManager items');
    }
    ...
    {
        return $this->__('This plugin shows a list of surveys and other items of the SurveyManager module.');
    }
    ...
    public function getParameters()
    {
        ...
        if (ModUtil::available($this->modname) && ModUtil::loadApi($this->modname)) {
            $objectTypes['survey'] = array('name' => $this->__('Surveys'));
            $objectTypes['page'] = array('name' => $this->__('Pages'));
            $objectTypes['question'] = array('name' => $this->__('Questions'));
            $objectTypes['response'] = array('name' => $this->__('Responses'));
            $objectTypes['responseData'] = array('name' => $this->__('Response datas'));
        }
