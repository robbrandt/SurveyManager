 ...
 */
class SurveyManager_Util_Base_View extends Zikula_AbstractBase
{
    /**
    ...
    {
        $extParams = array();
        $hasAdminAccess = SecurityUtil::checkPermission('SurveyManager:' . ucwords($objectType) . ':', '::', ACCESS_ADMIN);
        if ($func == 'view') {
            if ($hasAdminAccess) {
