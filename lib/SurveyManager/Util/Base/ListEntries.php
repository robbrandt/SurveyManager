 ...
 */
class SurveyManager_Util_Base_ListEntries extends Zikula_AbstractBase
{
    /**
    ...
    public function getEntries($objectType, $fieldName)
    {
        ...
        switch ($objectType) {
            case 'survey':
                switch ($fieldName) {
                    case 'workflowState':
                        $entries = $this->getWorkflowStateEntriesForSurvey();
                        break;
                }
                break;
            case 'page':
            ...
            case 'response':
                switch ($fieldName) {
                    case 'workflowState':
                        $entries = $this->getWorkflowStateEntriesForResponse();
                        break;
                }
                break;
            case 'responseData':
                switch ($fieldName) {
                    case 'workflowState':
                        $entries = $this->getWorkflowStateEntriesForResponseData();
                        break;
                }
                break;
        }
     ...
     * @return array Array with desired list entries.
     */
    public function getWorkflowStateEntriesForSurvey()
    {
        $states = array();
     ...
     * @return array Array with desired list entries.
     */
    public function getWorkflowStateEntriesForResponse()
    {
        $states = array();
        $states[] = array('value'   => 'approved',
                          'text'    => $this->__('Approved'),
     ...
     * @return array Array with desired list entries.
     */
    public function getWorkflowStateEntriesForResponseData()
    {
        $states = array();
        $states[] = array('value'   => 'approved',
                          'text'    => $this->__('Approved'),
