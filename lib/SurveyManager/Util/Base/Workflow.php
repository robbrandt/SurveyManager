 ...
 */
class SurveyManager_Util_Base_Workflow extends Zikula_AbstractBase
{
    /**
    ...
    public function getActionsForObject($entity)
    {
        ...
        $listHelper = new SurveyManager_Util_ListEntries($this->serviceManager);
