 ...
 */
class SurveyManager_Form_Handler_Admin_Question_Base_Edit extends SurveyManager_Form_Handler_Admin_Edit
{
    /**
     * Pre-initialise hook.
     *
    ...
    public function initialize(Zikula_Form_View $view)
    {
        ...
        if ($this->mode == 'create') {
            ...
            if (!$modelHelper->canBeCreated($this->objectType)) {
                LogUtil::registerError($this->__('Sorry, but you can not create the question yet as other items are required which must be created before!'));
        ...
        $this->relationPresets['page'] = FormUtil::getPassedValue('page', '', 'GET');
        if (!empty($this->relationPresets['page'])) {
            $relObj = ModUtil::apiFunc($this->name, 'selection', 'getEntity', array('ot' => 'page', 'id' => $this->relationPresets['page']));
            if ($relObj != null) {
    ...
    protected function getRedirectCodes()
    {
        ...
        // user list of pages
        $codes[] = 'userViewPage';
        // user display page of treated page
    ...
    protected function getRedirectUrl($args)
    {
        ...
        switch ($this->returnTo) {
            ...
            case 'userDisplayPage':
                if (!empty($this->relationPresets['page'])) {
                    return ModUtil::url($this->name, 'user', 'display', array('ot' => 'page', 'id' => $this->relationPresets['page']));
                }
                return $this->getDefaultReturnUrl($args);
            default:
                return $this->getDefaultReturnUrl($args);
