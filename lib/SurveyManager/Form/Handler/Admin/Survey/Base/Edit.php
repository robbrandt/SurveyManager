 ...
 */
class SurveyManager_Form_Handler_Admin_Survey_Base_Edit extends SurveyManager_Form_Handler_Admin_Edit
{
    /**
     * Pre-initialise hook.
     *
    ...
    public function preInitialize()
    {
        ...
        $this->objectTypeCapital = 'Survey';
        $this->objectTypeLower = 'survey';
    ...
    public function initialize(Zikula_Form_View $view)
    {
        ...
        if ($this->mode == 'create') {
            ...
            if (!$modelHelper->canBeCreated($this->objectType)) {
                LogUtil::registerError($this->__('Sorry, but you can not create the survey yet as other items are required which must be created before!'));
    ...
    {
        // redirect to the list of surveys
    ...
    protected function getDefaultMessage($args, $success = false)
    {
        ...
        switch ($args['commandName']) {
            case 'submit':
                        if ($this->mode == 'create') {
                            $message = $this->__('Done! Survey created.');
                        } else {
                            $message = $this->__('Done! Survey updated.');
                        }
                        break;
            case 'delete':
                        $message = $this->__('Done! Survey deleted.');
                        break;
            default:
                        $message = $this->__('Done! Survey updated.');
                        break;
