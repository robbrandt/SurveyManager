 ...
 */
class SurveyManager_Form_Handler_Admin_Page_Base_Edit extends SurveyManager_Form_Handler_Admin_Edit
{
    /**
     * Pre-initialise hook.
     *
    ...
    public function initialize(Zikula_Form_View $view)
    {
        ...
        if ($this->mode == 'create') {
            ...
            if (!$modelHelper->canBeCreated($this->objectType)) {
                LogUtil::registerError($this->__('Sorry, but you can not create the page yet as other items are required which must be created before!'));
