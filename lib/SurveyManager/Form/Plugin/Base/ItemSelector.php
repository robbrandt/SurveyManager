 ...
 */
class SurveyManager_Form_Plugin_Base_ItemSelector extends Zikula_Form_Plugin_TextInput
{
    /**
    ...
    public function render(Zikula_Form_View $view)
    {
        ...
        if (!SecurityUtil::checkPermission('SurveyManager:' . ucwords($this->objectType) . ':', '::', ACCESS_COMMENT)) {
            return false;
        }
    ...
    {
        parent::decode($view);
        $this->objectType = FormUtil::getPassedValue('SurveyManager_objecttype', 'survey', 'POST');
        $this->selectedItemId = $this->text;
    }
}
