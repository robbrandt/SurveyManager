 ...
 */
     ...
     */
    class SurveyManager_Form_Plugin_Base_RelationSelectorAutoComplete extends SurveyManager_Form_Plugin_AbstractObjectSelector
    {
        /**
        ...
        public function render(Zikula_Form_View $view)
        {
            ...
            switch ($this->objectType) {
                case 'survey':
                    $entityNameTranslated = __('survey', $dom);
                    break;
                case 'page':
                    $entityNameTranslated = __('page', $dom);
                    break;
                case 'question':
                    $entityNameTranslated = __('question', $dom);
                    break;
                case 'response':
                    $entityNameTranslated = __('response', $dom);
                    break;
                case 'responseData':
                    $entityNameTranslated = __('response data', $dom);
                    break;
            }
            ...
            $createLink = '';
            if ($this->createLink != '') {
                $createLink = '<a id="' . $idPrefix . 'SelectorDoNew" href="' . DataUtil::formatForDisplay($this->createLink) . '" title="' . __f('Create new %s', array($entityNameTranslated), $dom) . '" class="z-button surveymanager-inline-button">' . __('Create', $dom) . '</a>';
            }

            $alias = $this->id;

            $result = '
                <div class="surveymanager-relation-rightside">'
                    . $addLink . '
                    <div id="' . $idPrefix . 'AddFields">
                        ...
                        <div id="' . $idPrefix . 'SelectorChoices" class="surveymanager-autocomplete' . (($this->withImage) ? '-with-image' : '') . '"></div>
                        <input type="button" id="' . $idPrefix . 'SelectorDoCancel" name="' . $idPrefix . 'SelectorDoCancel" value="' . __('Cancel', $dom) . '" class="z-button surveymanager-inline-button" />'
                        . $createLink . '
