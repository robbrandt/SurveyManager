{* purpose of this template: pages view filter form in admin area *}
{checkpermissionblock component='SurveyManager:Page:' instance='::' level='ACCESS_EDIT'}
{assign var='objectType' value='page'}
<form action="{$modvars.ZConfig.entrypoint|default:'index.php'}" method="get" id="surveyManagerPageQuickNavForm" class="surveymanager-quicknav">
    <fieldset>
...
/* <![CDATA[ */
    document.observe('dom:loaded', function() {
        surveymanInitQuickNavigation('page', 'admin');
