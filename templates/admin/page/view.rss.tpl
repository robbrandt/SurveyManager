{* purpose of this template: pages rss feed in admin area *}
...
{foreach item='page' from=$items}
    <item>
        ...
        <link>{modurl modname='SurveyManager' type='admin' func='view' ot='page' fqurl='1'}</link>
        <guid>{modurl modname='SurveyManager' type='admin' func='view' ot='page' fqurl='1'}</guid>
