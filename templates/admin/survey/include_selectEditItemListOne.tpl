{* purpose of this template: inclusion template for display of related survey in admin area *}
...
<li id="{$idPrefixItem}">
    ...
    <a id="{$idPrefixItem}Edit" href="{modurl modname='SurveyManager' type='admin' func='edit' ot='survey' id=$item.id}">{$editImage}</a>
