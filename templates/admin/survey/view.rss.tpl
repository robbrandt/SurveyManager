{* purpose of this template: surveys rss feed in admin area *}
...
{foreach item='survey' from=$items}
    <item>
        ...
        <link>{modurl modname='SurveyManager' type='admin' func='view' ot='survey' fqurl='1'}</link>
        <guid>{modurl modname='SurveyManager' type='admin' func='view' ot='survey' fqurl='1'}</guid>
