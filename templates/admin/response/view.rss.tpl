{* purpose of this template: responses rss feed in admin area *}
...
{foreach item='response' from=$items}
    <item>
        ...
        <link>{modurl modname='SurveyManager' type='admin' func='view' ot='response' fqurl='1'}</link>
        <guid>{modurl modname='SurveyManager' type='admin' func='view' ot='response' fqurl='1'}</guid>
