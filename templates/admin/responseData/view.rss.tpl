{* purpose of this template: response datas rss feed in admin area *}
...
{foreach item='responseData' from=$items}
    <item>
        ...
        <link>{modurl modname='SurveyManager' type='admin' func='view' ot='responseData' fqurl='1'}</link>
        <guid>{modurl modname='SurveyManager' type='admin' func='view' ot='responseData' fqurl='1'}</guid>
