...
<div style="margin-left: 80px">
    <div class="z-formrow">
        {formlabel for='surveyManagerObjectType' __text='Object type'}
            {surveymanagerObjectTypeSelector assign='allObjectTypes'}
            {formdropdownlist id='surveyManagerObjectType' dataField='objectType' group='data' mandatory=true items=$allObjectTypes}
    ...
    <div{* class="z-formrow"*}>
        ...
        {surveymanagerItemSelector id='id' group='data' objectType=$objectType}
    </div>
