...
{pageaddvar name='javascript' value='modules/SurveyManager/javascript/SurveyManager.js'}
{pageaddvar name='stylesheet' value='modules/SurveyManager/style/manual.css'}

{if !isset($smarty.get.theme) || $smarty.get.theme ne 'Printer'}
    <div class="z-frontendbox">
        <h2>{gt text='Survey manager' comment='This is the title of the header template'}</h2>
        {modulelinks modname='SurveyManager' type='user'}
    </div>
{/if}
