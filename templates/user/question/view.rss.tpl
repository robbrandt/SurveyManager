{* purpose of this template: questions rss feed in user area *}
...
{foreach item='question' from=$items}
    <item>
        ...
        <link>{modurl modname='SurveyManager' type='user' func='display' ot='question' id=$question.id fqurl='1'}</link>
        <guid>{modurl modname='SurveyManager' type='user' func='display' ot='question' id=$question.id fqurl='1'}</guid>
