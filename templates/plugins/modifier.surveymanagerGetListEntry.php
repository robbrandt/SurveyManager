...
/**
 * The surveymanagerGetListEntry modifier displays the name
 ...
 */
function smarty_modifier_surveymanagerGetListEntry($value, $objectType = '', $fieldName = '', $delimiter = ', ')
{
    ...
    $helper = new SurveyManager_Util_ListEntries($serviceManager);
