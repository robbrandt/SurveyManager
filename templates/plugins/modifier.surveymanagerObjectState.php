...
/**
 * The surveymanagerObjectState modifier displays the name of a given object's workflow state.
 * Examples:
 *    {$item.workflowState|surveymanagerObjectState}       {* with visual feedback *}
 *    {$item.workflowState|surveymanagerObjectState:false} {* no ui feedback *}
 *
