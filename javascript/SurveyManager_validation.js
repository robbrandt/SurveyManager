...
function surveymanToday(format)
{
...
function surveymanReadDate(val, includeTime)
{
 ...
 */
function surveymanAddCommonValidationRules(objectType, id)
{
    Validation.addAllThese([
        ['validate-nospace', Zikula.__('No spaces', 'module_surveymanager_js'), function(val, elem) {
            var valStr;
